...
npm install --save-dev eslint eslint-plugin-import@latest @typescript-eslint/eslint-plugin @typescript-eslint/parser @typescript-eslint/typescript-estree eslint-config-prettier eslint-plugin-prettier prettier tsx tsconfig-paths typescript@4.9.5 esbuild
